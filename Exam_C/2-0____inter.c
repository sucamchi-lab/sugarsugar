...
Escriba un programa que tome dos lineas y se muestre sin dobles.
caracteres caracteres que aparecen en ambas lineas, en el orden en que
aparecen en el primero.

Le seguira una nueva linea.
