...
Escriba un programa llamado alpha_mirror que tome una cadena y muestre
esta linea despues de reemplazar cada caracter alfabetico con el alfabetico opuesto
caracter seguido de una nueva linea.
...
Si el numero de argumentos no es 1, solo se muestra la nueva linea.
