...
Escribe una funcion que convierta el argumento de cadena 'str'
a un numero entero (escriba int) y lo devuelve.

Funciona igual que la funcion estandar atoi(const char * str).
consulte el manual "hombre".
