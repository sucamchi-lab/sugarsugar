...
Escriba un programa que tome una cadena y la muestre al reves
orden seguido de una nueva linea.

Si el numero de parametros no es 1, el programa muestra una nueva linea.
