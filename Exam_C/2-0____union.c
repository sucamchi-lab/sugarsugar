...
Escriba un programa que tome dos cadenas y se muestre sin caracteres dobles.
caracteres que aparecen solo en una de las lineas.

La visualizacion estara en el orden en que aparecen los caracteres en la linea de comando,
y les seguira una nueva linea.

Si el numero de argumentos no es 2, el programa muestra una nueva linea.
