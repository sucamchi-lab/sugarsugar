...
Escriba un programa que tome una cadena y muestre su ultima palabra seguida de una nueva linea.

Una palabra es una seccion de una linea separada por espacios/tabulaciones o el inicio/final de una linea.

Si el numero de parametros no es 1 o no hay palabras, muestre una nueva linea.
